...
public class LocalEditDistanceStrategy extends AbstractStrategy
{

	public static void main(String[] args)
	{
		LocalEditDistanceStrategy task=new LocalEditDistanceStrategy();
	...
	private static Logger log = Logger
			.getLogger(LocalEditDistanceStrategy.class);
	...
	public void dealWithOneTweet(Tweet tmpTweet)
	{
		...
		if(match_rate>=LocalEditDistanceStrategy.THRESHOLD)
